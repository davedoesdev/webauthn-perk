...
fastify.register(require('webauthn-perk'), {
    webauthn_perk_options: {
        authorize_jwt_options: {
            ...
            no_updates: true,
            WEBAUTHN_MODE: true
            // See https://github.com/davedoesdev/authorize-jwt for more options
        },
        cred_options: {
        ...
        perk_options: {
            ...
            // TODO:
            // perk be able to override these options
            // expected_origin: `https://${request.headers.host}`,
            // expected_factor: 'either',
            // prev_counter: 0
            // POST to cred/id should also call complete_webauthn_token
        }
    }
});
----