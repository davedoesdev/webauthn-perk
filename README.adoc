...
2. Visit the URL it displays in your WebAuthn-supporting browser. The source to
   this page is in link:test/fixtures/example.html[]. 

3. Use your security token to register.

4. Type in a message and click *Register*.

5. You'll be shown another URL. Open this in a different browser (doesn't have to
   support Webauthn).
