...
**Note:** From version 6.0.0, `webauth-perk` uses https://github.com/davedoesdev/webauthn4js[WebAuthn4JS] instead of https://github.com/webauthn-open-source/fido2-lib[fido2-lib] and the API has changed accordingly.
